    ...
    <div className="p-4">
     ...
     <span className="flex absolute items-center w-[350px] justify-center">
      ...
      <div className="flex flex-row gap-7">
       <p className="flex bg-[#1CA8CB] rounded-xl w-[65px] h-[65px] items-center justify-center font-semibold text-2xl text-white">26<br/>Nov</p>
      ...
      <h3 className="w-[300px] font-semibold text-2xl cursor-pointer hover:text-[#1CA8CB]">{blogdetails}</h3>
      <button className="flex flex-row items-center gap-3 font-semibold 2xl cursor-pointer hover:text-[#1CA8CB]">Read More <GrLinkNext /></button>
      </div>
      </span>
    </div>
  )
