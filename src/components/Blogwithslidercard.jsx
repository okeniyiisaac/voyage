  ...
  return (
   <div className="flex p-5 border rounded-[20px] w-fit border-blue-100 flex-col gap-3">
    ...
    <div className="flex flex-row gap-3">
     ...
     <h3 className=" font-semibold text-2xl cursor-pointer hover:text-[#1CA8CB]">{blogsliderheader}</h3>
     <p className="lg:w-[650px]">{blogslidertext}</p>
      <a href="#" className="flex flex-row items-center gap-3 font-semibold rounded-3xl w-fit h-fit px-6 py-4 bg-[#1CA8CB] 2xl cursor-pointer hover:bg-right transition-all duration-500 ease-out bg-[length:200%_100%]  bg-left bg-gradient-to-l from-black to-[blue-500] text-white">Read More <GrLinkNext /></a>
     </div>
