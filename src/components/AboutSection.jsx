            ...
            <div className="container">
                <div className="about-us_wrapper w-fit lg:flex lg:gap-5 grid justify-between">
                    <div  className="about-us_image relative w-full h-[100%]">
                        ...
                        <div className="mt-14 absolute lg:left-0 lg:top-[470px] right-0 bottom-0 flex items-center gap-3 pl-2 md:mt-16 z-[1000]">
                    ...
                    <div className="about-us_content w-full">
                        ...
                        <span className="text-cyan-600 font-medium sub-title">Get About Us</span>
                        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl lg:leading-[3.5rem] leading-[2rem]">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="lg:flex gap-2">
                                <h4 className="font-semibold text-lg">Easy Booking System</h4>
