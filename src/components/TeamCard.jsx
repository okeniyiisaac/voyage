...
const TeamCard = ({ teamCardBg, teamName, teamTitle }) => {
  return (
    <div className='rounded-xl h-full group relative'>
        <div className='w-full h-[400px] bg-cover rounded-xl bg-center bg-[url(https://websitedemos.net/brandstore-02/wp-content/uploads/sites/150/2019/12/home-new-bg-free-img.jpg)] relative' style={{backgroundImage: `url(${teamCardBg})`}}>    
        </div>
