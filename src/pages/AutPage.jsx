        ...
        <AnimatePresence mode="wait">
          {isLogin ? (
            <motion.div
              ...
              style={{
                backgroundImage:
                  "url('https://turmet-react.vercel.app/assets/img/hero/hero2.jpg')",
              }}
            >
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "url('https://turmet-react.vercel.app/assets/img/breadcrumb/breadcrumb.jpg')",
              }}
            >
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          ...
          <AnimatePresence mode="wait">
            {isLogin ? (
              ...
              >
                ...
                <button
                  onClick={handleLogin}
                  className="bg-white w-full text-blue-900 font-bold py-2 rounded-full mt-4 hover:bg-gray-200 transition"
                >
                  ENTER
                </button>
                </Link>
              ...
              >
                ...
                <Link to="/userProfile">
                <button className="bg-white w-full text-blue-900 font-bold py-2 rounded-full mt-4 hover:bg-gray-200 transition mb-28">
                  REGISTER
                </button>
                </Link>
              </motion.form>
